...
class EcomAppTest {
	    ...
	    void testCreateProduct() throws SQLException {
	        Product product = new Product(0, "Laptop", 50000, "High-end Laptop", 10);
	    ...
	    void testAddToCart() throws SQLException {
	        // Assume customer ID = 1 and product ID = 1
	        int customerId = 1;
	        int productId = 1;
	        int quantity = 2;
	    ...
	    void testProductNotFoundException() {
	        int nonExistentProductId = 1; // Product that does not exist in the database
	        int customerId = 1; // Assume this customer exists
	        int quantity = 1;
